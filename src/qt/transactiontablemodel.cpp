...
QString TransactionTableModel::formatTxStatus(const TransactionRecord *wtx) const
{
    ...
    if((wtx->type == TransactionRecord::Generated) || (wtx->type == TransactionRecord::Staked)) {
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx,
  bool showUnconfirmed) const {
    QString str = CoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(),
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case ConfirmedRole:
        ...
        return(rec->status.confirmed &&
          !(((rec->type == TransactionRecord::Generated) || (rec->type == TransactionRecord::Staked)) &&
