    ...
    transactionView(0)
{
    ...
    typeWidget->addItem(tr("PoS Mined"), TransactionFilterProxy::TYPE(TransactionRecord::Staked));
    ...
    QAction *copyTxIDAction = new QAction(tr("Copy payment ID"), this);
    QAction *editLabelAction = new QAction(tr("Edit label"), this);
    QAction *showDetailsAction = new QAction(tr("Show transaction details"), this);
    QAction *showBlockExplorer = new QAction(tr("Show payment in block explorer"), this);
...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if(CoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed)) {
